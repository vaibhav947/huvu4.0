...
backgroundGradient.addColorStop(0, '#A9D1EA')
backgroundGradient.addColorStop(1, '#C9CCD5')
...
function animate() {
    ...
    if(flag) creatMountainRange(1, canvas.height * 0.7, '#f4c2c2')
    if(flag) creatMountainRange(2, canvas.height * 0.6, '#ffc1cc')
    if(flag) creatMountainRange(3, canvas.height * 0.4, '#cb9b9b')
    c.fillStyle = '#182028'
